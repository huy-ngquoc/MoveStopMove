...
[CustomPropertyDrawer(typeof(ResolveComponentFromSelfAttribute))]
public sealed class ResolveComponentFromSelfDrawer : PropertyDrawer
{
    private bool hierarchyChanged = false;

    public ResolveComponentFromSelfDrawer()
    {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        {
            this.ResolveComponentFromSelfLogic(property);
            this.hierarchyChanged = false; // Reset flag
        }
    }

    private void ResolveComponentFromSelfLogic(SerializedProperty property)
    {
        ...
        {
            Debug.LogError($"`{nameof(ResolveComponentFromSelfAttribute)}` is not valid " +
