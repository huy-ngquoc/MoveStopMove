...
public sealed class ResolveComponentFromParentAttribute : PropertyAttribute
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ResolveComponentFromParentAttribute"/> class
    /// to automatically assign a component from the GameObject or any of its parent, excluding inactive ones by default.
    /// </summary>
    /// <remarks>
    /// The field must be serialized by Unity for this attribute to work.
    /// </remarks>
    public ResolveComponentFromParentAttribute()
    {
    }
    ...
    public ResolveComponentFromParentAttribute(string targetParentName)
    {
    ...
    public ResolveComponentFromParentAttribute(bool isIncludingInactive)
    {
    ...
    /// <param name="targetParentName"> The name of the GameObject or its parent to search within. Leave blank to search all.</param>
    /// <param name="isIncludingInactive"> If `true`, includes inactive GameObjects in the search. If `false`, ignores them.</param>
    public ResolveComponentFromParentAttribute(string targetParentName, bool isIncludingInactive)
    {
        this.TargetParentName = targetParentName;
        this.IsIncludingInactive = isIncludingInactive;
    }

    public string TargetParentName { get; } = string.Empty;
